...
public class Filter {
    ...
    public boolean isShowingFemales() {
        return filterRows.get(filterRows.size() - 1).isOn();//this is because the female filter is the last one in the arraylist
    }
    ...
    public boolean isShowingMales() {
        return filterRows.get(filterRows.size() - 2).isOn();
    }
